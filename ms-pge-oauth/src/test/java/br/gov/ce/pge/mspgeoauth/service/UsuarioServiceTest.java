...
public class UsuarioServiceTest {
    ...
    @Test
    void test_authenticate_get_usuario_cpf_feign_exception() {

        when(client.findByCpf(any())).thenThrow(FeignException.class);

        assertThrows(NegocioException.class, () -> usuarioService.loadUserByUsername(any()));
    ...
    void test_authenticate_get_usuario_feign_exception() {
        ...
        assertThrows(NegocioException.class, () -> usuarioService.getPrincipalUsuario("usuario", "username"));
