...
class PermissaoControllerTest {
	...
	public void test_historico_ok() throws Exception {
		when(service.findHistorys(UUID.fromString("a597aa9e-0a05-48de-adcb-a7a1b631aedd"), 1, 10)).thenReturn(PaginacaoResponseDtoTest.getPaginacaoHistoricoPermissao());
