...
public class UsuarioServiceImplTest {
    ...
    void save_sucesso() throws MessagingException, TemplateException, IOException {
        ...
        usuarioService.save(UsuarioRequestDtoTest.getRequest(), anyString());
    ...
    void save_sucesso_sistema_portal_origens() throws MessagingException, TemplateException, IOException {
        ...
        usuarioService.save(UsuarioRequestDtoTest.getRequestUsuarioInterno(), anyString());
    ...
    void save_interno_error() {
        ...
        Exception error = assertThrows(NegocioException.class, () -> {
			...
			usuarioService.save(request, anyString());
        });
    ...
    void update_sucesso() throws Exception {
        ...
        usuarioService.update(id, UsuarioRequestDtoTest.getRequestUsuarioInterno(), anyString());
    ...
    void update_sucesso_objetos_iguais() throws Exception {
        ...
        usuarioService.update(id, UsuarioRequestDtoTest.getRequestObjetoIgual(), anyString());
    ...
    void update_sucesso_outro_email() throws Exception {
        ...
        usuarioService.update(id, UsuarioRequestDtoTest.getRequestOther(), anyString());
    ...
    void update_sucesso_other_cpf() throws Exception {
		...
		usuarioService.update(id, request, anyString());
