...
class TipoPessoaControllerTest {
  MockMvc mockMvc;
  ...
  @InjectMocks
  private TipoPessoaController controller;
  ...
  void test_list_all_ok() throws Exception {
    when(service.findAll()).thenReturn(Arrays.asList(TipoPessoaTest.getTipoPessoaFisica()));

    mockMvc.perform(MockMvcRequestBuilders.get("/tipo-pessoa")
