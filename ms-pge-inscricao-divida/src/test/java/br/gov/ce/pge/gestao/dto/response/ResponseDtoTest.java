...
class ResponseDtoTest {
  ...
  void test_from_data() {
    ...
    URI uri = URI.create("http://localhost:8080/inscricao/");
  ...
  void test_get_errors() {
    List<String> errors = Arrays.asList("Erro ao Salvar Inscrição", "Erro ao Salvar Inscrição");
  ...
  @Test
  void test_add_error() {
    String error = "Erro ao Salvar Inscrição";
    ResponseDto<String> responseDto = new ResponseDto<String>();
