...
class TipoPapelPessoaDividaControllerTest {
  MockMvc mockMvc;

  @Mock
  private TipoPapelPessoaDividaService service;

  @InjectMocks
  private TipoPapelPessoaDividaController controller;
  ...
  void test_list_all_ok() throws Exception {
    when(service.findAll()).thenReturn(Arrays.asList(TipoPapelPessoaDividaTest.getTipoPapelPessoaDevedor()));

    mockMvc.perform(MockMvcRequestBuilders.get("/tipo-papel-pessoa")
