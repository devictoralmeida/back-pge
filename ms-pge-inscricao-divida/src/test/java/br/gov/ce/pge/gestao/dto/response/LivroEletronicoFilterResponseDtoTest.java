...
public class LivroEletronicoFilterResponseDtoTest {
    public static LivroEletronicoFilterResponseDto get_livro_eletronico_filter() {

        LivroEletronicoFilterResponseDto filter = new LivroEletronicoFilterResponseDto();
        filter.setPaginas(1);
    ...
    public static List<LivroEletronicoFilterResponseDto> get_livro_eletronico_filters_list() {
