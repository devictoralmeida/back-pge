...
@RestController
@RequestMapping(value = "tipo-devedor")
public class TipoDevedorController {
  private final TipoDevedorService service;

  public TipoDevedorController(TipoDevedorService service) {
    this.service = service;
  }

  @GetMapping
  public ResponseEntity<ResponseDto<List<TipoDevedor>>> findAll() {
