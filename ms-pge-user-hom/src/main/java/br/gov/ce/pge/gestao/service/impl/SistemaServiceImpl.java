...
public class SistemaServiceImpl implements SistemaService {
	...
	private static final String NAO_ENCONTRADO = "Sistema não encontrado";
	...
	public PaginacaoResponseDto<List<HistoricoAtualizacaoResponseDto>> findHistorys(UUID id, Integer page) {
		...
		List<AuditoriaDto> historysUpdates =  this.sistemaDao.findHistorysUpdates(id, offset, ITENS_POR_PAGINA);
