...
public class UsuarioEmailSenhaServiceImpl implements UsuarioEmailSenhaService {
    ...
    private static final int TENTATIVA_MAXIMA_SOLICITACAO = 3;
	private static final String TEMPLATE_RECUPERAR_SENHA_FTLH = "recuperar-senha.ftlh";
	private static final String TEMPLATE_ALTERAR_SENHA_FTLH = "alterar-senha.ftlh";
	private static final String URL = "url";
	private static final String ASSUNTO = "assunto";
	private static final String URL_SISTEMA_PORTAL_ORIGENS = "url.sistema.portalOrigens";
	private static final String URL_SISTEMA_PORTAL_DIVIDA = "url.sistema.portalDivida";
	private static final String ACAO_RECUPERAR = "recuperar";
	private static final String ACAO_ALTERAR = "alterar";
	private static final String PORTAL_DAS_ORIGENS = "Portal das Origens";
	private static final String PORTAL_DIVIDA_ATIVA = "Portal da Dívida Ativa";
    ...
    public void sendChangeEmail(UsuarioCadastroSenhaRequestDto request, UUID id, String nomeSistema) {
        ...
        this.dispararEmail(usuario, nomeSistema, TEMPLATE_ALTERAR_SENHA_FTLH, ACAO_ALTERAR);
    }
    ...
    public void sendRecoveryEmail(String email, String nomeSistema) {
        ...
        this.dispararEmail(usuario, nomeSistema, TEMPLATE_RECUPERAR_SENHA_FTLH, ACAO_RECUPERAR);
    ...
    private void validarUsuario(Usuario usuario) {
        ...
        if(solicitacoes.size() >= TENTATIVA_MAXIMA_SOLICITACAO) {
    ...
    private void dispararEmail(Usuario usuario, String nomeSistema, String template, String acao) {
        ...
        if(nomeSistema.equals(PORTAL_DIVIDA_ATIVA)) {
            urlAmbiente = PropertiesConfig.getProperty(URL_SISTEMA_PORTAL_DIVIDA);
        }else if(nomeSistema.equals(PORTAL_DAS_ORIGENS)){
            urlAmbiente = PropertiesConfig.getProperty(URL_SISTEMA_PORTAL_ORIGENS);
        }else {
            throw new NegocioException(MessageCommonsContanst.MENSAGEM_SISTEMA_INEXISTENTE);
        }

        params.put("urlCadastro", urlAmbiente + "autenticacao/" + dataEmail.get(URL));
        ...
        try {
            enviarEmailService.enviarEmailTemplate(dataEmail.get(ASSUNTO), usuario.getEmail(), template, params);
    ...
    private Map<String, String> getDataEmail(String acao, String nomeSistema, Usuario usuario) {
        ...
        return Map.of(ASSUNTO, assunto + nomeSistema, URL, url);
    }
