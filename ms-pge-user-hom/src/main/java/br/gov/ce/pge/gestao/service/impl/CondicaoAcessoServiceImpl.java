...
public class CondicaoAcessoServiceImpl implements CondicaoAcessoService {
    ...
    private static final String NAO_ENCONTRADO = "Condição de acesso não existe";

	private static final int INTERVALO_BLOQUEIO = 30;
    ...
    public CondicaoAcesso save(@Valid CondicaoAcessoRequestDto request) {
        ...
        condicaoAcessoModel.setIntervaloBloqueio(INTERVALO_BLOQUEIO);
