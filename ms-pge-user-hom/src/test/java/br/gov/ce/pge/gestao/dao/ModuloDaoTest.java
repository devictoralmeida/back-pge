...
public class ModuloDaoTest {
	...
	public void contar_historico() {
        ...
        when(sqlSession.selectOne(eq("ModuloDao.countHistorysUpdates"), anyMap())).thenReturn(1);
	...
	public void historico() throws JsonProcessingException {
		...
		UUID permissaoId = UUID.fromString("e038f9db-5bfe-4a32-aff1-ad51f67b0999");
        when(sqlSession.selectList(eq("ModuloDao.findHistorysUpdates"), anyMap())).thenReturn(List.of(AuditoriaModuloDtoTest.getAuditoria()));
