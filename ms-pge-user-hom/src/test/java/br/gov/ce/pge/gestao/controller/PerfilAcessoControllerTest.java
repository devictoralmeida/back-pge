...
class PerfilAcessoControllerTest {
	...
	public void test_save_ok() throws Exception {
		when(service.save(any())).thenReturn(PerfilAcessoTest.getPerfilAcesso());
	...
	public void test_update_ok() throws Exception {
		when(service.update(any(),any())).thenReturn(PerfilAcessoTest.getPerfilAcessoUpdate());
	...
	public void test_historico_ok() throws Exception {
		when(service.findHistorys(UUID.fromString("a597aa9e-0a05-48de-adcb-a7a1b631aedd"),1)).thenReturn(PaginacaoResponseDtoTest.getPaginacaoHistoricoPerfil());
	...
	public void test_historico_lista_vazia_ok() {
		doThrow(new HistoricoAtualizacaoNotFoundException("O Perfil de acesso selecionado não possui histórico de edições.")).when(service).findHistorys(any(), eq(0));
	...
	public void test_filter_ok() throws Exception {
		when(service.findByFilter(PerfilAcessoFilterRequestDtoTest.getRequestFilter(),1, "nome")).thenReturn(PaginacaoResponseDtoTest.getPaginacaoFilterPerfil());
	    ...
	    verify(service, times(1)).findByFilter(PerfilAcessoFilterRequestDtoTest.getRequestFilter(),1, "nome");

	}
	
	@Test
	public void test_filter_lista_vazia_ok() throws Exception {
		when(service.findByFilter(PerfilAcessoFilterRequestDtoTest.getRequestFilter(),1, "nome")).thenReturn(PaginacaoResponseDto.fromResultado(List.of(), 1, 1, 1));
