...
public class TipoReceitaServiceImpl implements TipoReceitaService {
	...
	@Override
	public TipoReceitaResponseDto save(TipoReceitaRequestDto request, String nomeUsuario) {
	...
	@Override
	public TipoReceitaResponseDto update(UUID id,@Valid TipoReceitaUpdateRequestDto request, String nomeUsuario) throws JsonProcessingException {
	...
	public PaginacaoResponseDto<List<HistoricoAtualizacaoResponseDto>> findHistorys(UUID id, Integer page, Integer tamanho) {
		...
		List<AuditoriaDto> historysUpdates = this.auditoriaDao.findHistorysUpdates(id, PaginacaoUtil.getOffset(page, tamanho), tamanho, "TipoReceita");
