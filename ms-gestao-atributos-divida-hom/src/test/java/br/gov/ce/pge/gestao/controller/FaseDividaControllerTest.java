...
public class FaseDividaControllerTest {
    ...
    public void test_cadastro_fase_divida_ok() throws Exception {
        when(service.save(any())).thenReturn(FaseDividaResponseDtoTest.getResponse());
    ...
    public void test_cadastro_error() throws Exception {
        doThrow(new NegocioException("O nome da fase é igual ao nome da fase junit já cadastrada.")).when(service).save(any());
    ...
    public void test_update_fase_divida_ok() throws Exception {
        when(service.update(any(),any())).thenReturn(FaseDividaResponseDtoTest.getResponseUpdate());
    ...
    public void test_update_error() throws Exception {
        doThrow(new NegocioException("O nome da fase é igual ao nome da fase Teste Junit já cadastrada.")).when(service).update(any(), any());
    ...
    public void test_consulta_historico_por_id_ok() throws Exception {
        when(service.viewChangeHistoryById(any(UUID.class), eq(1))).thenReturn(HistoricoAtualizacaoDtoTest.getResponse());
        ...
        verify(service, times(1)).viewChangeHistoryById(any(UUID.class), eq(1));
        verifyNoMoreInteractions(service);
    }
