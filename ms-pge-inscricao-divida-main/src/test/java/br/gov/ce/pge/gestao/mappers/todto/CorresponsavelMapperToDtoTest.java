...
class CorresponsavelMapperToDtoTest {
    ...
    void teste_converter() {
        CorresponsavelResponseDto dto = CorresponsavelMapperToDto.converter(CorresponsavelTest.get_corresponsavel_pessoa_fisica());
    ...
    void teste_converter_lista() {
        List<CorresponsavelResponseDto> listaDto = CorresponsavelMapperToDto.converterList(CorresponsavelTest.get_list_corresponsaveis());
