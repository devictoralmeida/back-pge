...
public class CorresponsavelTest {
    ...
    public static Corresponsavel get_corresponsavel_pessoa_fisica() {
        var model = new Corresponsavel();
        model.setId(UUID.fromString("25ffe4c1-5db9-4150-8257-132c082e6b79"));
    ...
    public static Corresponsavel get_corresponsavel_pessoa_juridica() {
        var model = new Corresponsavel();
        model.setId(UUID.fromString("bf8eb292-8fd1-47e7-ae5b-51acb860f555"));
    ...
    public static List<Corresponsavel> get_list_corresponsaveis() {
        Corresponsavel corresponsavel1 = get_corresponsavel_pessoa_fisica();
        Corresponsavel corresponsavel2 = get_corresponsavel_pessoa_juridica();
        return new ArrayList<>(List.of(corresponsavel1, corresponsavel2));
    }

    @Test
    public void teste_pessoa_fisica() {
        var model = get_corresponsavel_pessoa_fisica();
    ...
    public void teste_pessoa_juridica() {
        var model = get_corresponsavel_pessoa_juridica();
