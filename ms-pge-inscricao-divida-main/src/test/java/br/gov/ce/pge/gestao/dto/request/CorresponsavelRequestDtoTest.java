...
public class CorresponsavelRequestDtoTest {
	...
	public static CorresponsavelRequestDto getCorresponsavelPessoaFisica() {
	...
	public static CorresponsavelRequestDto getCorresponsavelPessoaJuridica() {
		var dto = new CorresponsavelRequestDto();
	...
	public static List<CorresponsavelRequestDto> getListCorresponsaveis() {
