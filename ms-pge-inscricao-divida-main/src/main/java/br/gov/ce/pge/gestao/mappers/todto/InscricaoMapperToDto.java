...
public class InscricaoMapperToDto {
	...
	public static InscricaoResponseDto converter(Inscricao inscricao) {
		...
		dto.setDivida(Objects.isNull(inscricao.getDivida())? null : DividaMapperToDto.converter(inscricao.getDivida()));
