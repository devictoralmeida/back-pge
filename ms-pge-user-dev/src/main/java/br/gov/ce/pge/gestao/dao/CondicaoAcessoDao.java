...
public class CondicaoAcessoDao extends CommonsDao {
    ...
    public int countHistorysUpdates(UUID id) {
        return this.sqlSession.selectOne("CondicaoAcessoDao.countHistorysUpdates", CommonsDao.getParamsCount(id));
    }

    @Override
    public List<AuditoriaDto> findHistorysUpdates(UUID id, Long offset, Long limit) {
        return this.sqlSession.selectList("CondicaoAcessoDao.findHistorysUpdates", CommonsDao.getParamsHistorys(id, offset, limit));
    }
}
